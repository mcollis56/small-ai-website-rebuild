...
<li>
<a href="/ai-solution-finder" className="text-sm leading-6 text-gray-300 hover:text-white">
AI Solution Finder
</a>
</li>
<li>
...
<h3 className="text-sm font-semibold leading-6 text-white">Legal & Contact</h3>
<ul role="list" className="mt-6 space-y-4">
<li>
